...
class OrderMasterController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $rafcuttings = DB::select('select distinct(order_list.order_list),order_list.lot_no,order_list.pobuyer_no,order_list.dcpo_qty,size.size,raf_production.raf_date,ifnull((select sum(order_size.qty) from order_size where order_size.order_list = raf_production.order_list and order_size.size_no = size.size_no and order_size.void = "false"),0) as size_qty,raf_production.raf_qty,((select sum(raf_qty) from raf_production t2 where t2.raf_date <= raf_production.raf_date and t2.raf_dept = "DEP000000001" and t2.size_no = raf_production.size_no and t2.order_list = order_list.order_list and t2.void = "false" and void = "false" order by order_list,size_no,raf_date)) as totalraf,((select sum(raf_qty) from raf_production t2 where t2.raf_date <= raf_production.raf_date and t2.raf_dept = "DEP000000001" and t2.size_no = raf_production.size_no and t2.order_list = order_list.order_list and t2.void = "false" and void = "false" order by order_list,size_no,raf_date)-ifnull((select sum(order_size.qty) from order_size where order_size.order_list = raf_production.order_list and order_size.size_no = size.size_no and order_size.void = "false"),0)) as balance from raf_production left join order_size on raf_production.size_no = order_size.size_no left join order_list on raf_production.order_list = order_list.order_list left join size on order_size.size_no = size.size_no where raf_production.raf_dept = "DEP000000001" and raf_production.order_trans = "' . $order_trans . '" and raf_production.void = "false" order by order_list.order_list,raf_date');
    ...
    {
        if ($request->ajax()) {
            $rafsewings = DB::select('select distinct(order_list.order_list),order_list.lot_no,order_list.pobuyer_no,order_list.dcpo_qty,size.size,raf_production.raf_date,ifnull((select sum(order_size.qty) from order_size where order_size.order_list = raf_production.order_list and order_size.size_no = size.size_no and order_size.void = "false"),0) as size_qty,raf_production.raf_qty,((select sum(raf_qty) from raf_production t2 where t2.raf_date <= raf_production.raf_date and t2.raf_dept = "DEP000000002" and t2.size_no = raf_production.size_no and t2.order_list = order_list.order_list and t2.void = "false" and void = "false" order by order_list,size_no,raf_date)) as totalraf,((select sum(raf_qty) from raf_production t2 where t2.raf_date <= raf_production.raf_date and t2.raf_dept = "DEP000000002" and t2.size_no = raf_production.size_no and t2.order_list = order_list.order_list and t2.void = "false" and void = "false" order by order_list,size_no,raf_date)-ifnull((select sum(order_size.qty) from order_size where order_size.order_list = raf_production.order_list and order_size.size_no = size.size_no and order_size.void = "false"),0)) as balance from raf_production left join order_size on raf_production.size_no = order_size.size_no left join order_list on raf_production.order_list = order_list.order_list left join size on order_size.size_no = size.size_no where raf_production.raf_dept = "DEP000000002" and raf_production.order_trans = "' . $order_trans . '" and raf_production.void = "false" order by order_list.order_list,raf_date');
            // return response()->json($rafsewings);
                        ...
                        $instance
                            ...
                            ->where(function ($query) use ($searchSewing) {
                                $query->orWhere('order_list.lot_no', 'LIKE', "%$searchSewing%")
                                    ...
                                    ->orWhere('order_size.qty', 'LIKE', "%$searchSewing%")
                                    ->orWhere('size.size', 'LIKE', "%$searchSewing%")
    ...
    {
        if ($request->ajax()) {
            $rafirons = DB::select('select distinct(order_list.order_list),order_list.lot_no,order_list.pobuyer_no,order_list.dcpo_qty,size.size,raf_production.raf_date,ifnull((select sum(order_size.qty) from order_size where order_size.order_list = raf_production.order_list and order_size.size_no = size.size_no and order_size.void = "false"),0) as size_qty,raf_production.raf_qty,((select sum(raf_qty) from raf_production t2 where t2.raf_date <= raf_production.raf_date and t2.raf_dept = "DEP000000003" and t2.size_no = raf_production.size_no and t2.order_list = order_list.order_list and t2.void = "false" and void = "false" order by order_list,size_no,raf_date)) as totalraf,((select sum(raf_qty) from raf_production t2 where t2.raf_date <= raf_production.raf_date and t2.raf_dept = "DEP000000003" and t2.size_no = raf_production.size_no and t2.order_list = order_list.order_list and t2.void = "false" and void = "false" order by order_list,size_no,raf_date)-ifnull((select sum(order_size.qty) from order_size where order_size.order_list = raf_production.order_list and order_size.size_no = size.size_no and order_size.void = "false"),0)) as balance from raf_production left join order_size on raf_production.size_no = order_size.size_no left join order_list on raf_production.order_list = order_list.order_list left join size on order_size.size_no = size.size_no where raf_production.raf_dept = "DEP000000003" and raf_production.order_trans = "' . $order_trans . '" and raf_production.void = "false" order by order_list.order_list,raf_date');
            // return response()->json($rafirons);
                        ...
                        $instance
                            ...
                            ->where(function ($query) use ($searchIron) {
                                $query->orWhere('order_list.lot_no', 'LIKE', "%$searchIron%")
                                    ...
                                    ->orWhere('order_size.qty', 'LIKE', "%$searchIron%")
                                    ->orWhere('size.size', 'LIKE', "%$searchIron%")
    ...
    {
        if ($request->ajax()) {
            $rafpackings = DB::select('select distinct(order_list.order_list),order_list.lot_no,order_list.pobuyer_no,order_list.dcpo_qty,size.size,raf_production.raf_date,ifnull((select sum(order_size.qty) from order_size where order_size.order_list = raf_production.order_list and order_size.size_no = size.size_no and order_size.void = "false"),0) as size_qty,raf_production.raf_qty,ifnull(raf_production.carton_qty,0) as carton_qty,((select sum(raf_qty) from raf_production t2 where t2.raf_date <= raf_production.raf_date and t2.raf_dept = "DEP000000004" and t2.size_no = raf_production.size_no and t2.order_list = order_list.order_list and t2.void = "false" and void="false" order by order_list,size_no,raf_date)) as totalraf,((select sum(carton_qty) from raf_production t2 where t2.raf_date <= raf_production.raf_date and t2.raf_dept = "DEP000000004" and t2.size_no = raf_production.size_no and t2.order_list = order_list.order_list and t2.void = "false" and void = "false" order by order_list,size_no,raf_date)) as totalcarton,((select sum(raf_qty) from raf_production t2 where t2.raf_date <= raf_production.raf_date and t2.raf_dept = "DEP000000004" and t2.size_no = raf_production.size_no and t2.order_list = order_list.order_list and t2.void = "false" and void = "false" order by order_list,size_no,raf_date)-ifnull((select sum(order_size.qty) from order_size where order_size.order_list = raf_production.order_list and order_size.size_no = size.size_no and order_size.void = "false"),0)) as raf_balance,((select sum(carton_qty) from raf_production t2 where t2.raf_date <= raf_production.raf_date and t2.raf_dept = "DEP000000004" and t2.size_no = raf_production.size_no and t2.order_list = order_list.order_list and t2.void = "false" and void = "false" order by order_list,size_no,raf_date)-ifnull((select sum(order_list.carton_qty) from order_list where order_list.order_list = raf_production.order_list and order_list.void = "false"),0)) as carton_balance from raf_production left join order_size on raf_production.size_no = order_size.size_no left join order_list on raf_production.order_list = order_list.order_list left join size on order_size.size_no = size.size_no where raf_production.raf_dept = "DEP000000004" and raf_production.order_trans = "' . $order_trans . '" and raf_production.void = "false" order by order_list.order_list,raf_date');
            ...
            return DataTables::of($rafpackings)
                ...
                ->rawColumns(['raf_date_formated'])
                ->addColumn('balance_color', function ($row) {
                    if ($row->raf_balance < 0) {
                        return '<font color="red"> ' . $row->raf_balance . '</font>';
                    } else {
                        return '<font color="green"> ' . $row->raf_balance . '</font>';
                    }
                })
                        ...
                        $instance
                            ...
                            ->where(function ($query) use ($searchPacking) {
                                $query->orWhere('order_list.lot_no', 'LIKE', "%$searchPacking%")
                                    ...
                                    ->orWhere('order_size.qty', 'LIKE', "%$searchPacking%")
                                    ->orWhere('size.size', 'LIKE', "%$searchPacking%")
