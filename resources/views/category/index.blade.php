                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="/category/find/{{ $category->id }}" class="btn btn-primary btn-circle btn-sm">
                                            ...
                                            <a class="btn btn-danger btn-circle btn-sm btn-void-record" data-void-link="void/{{ $category->id }}" data-void-name="{{ $category->category_name }}" data-toggle="modal" data-target="#voidModal">
                                                <i class="fas fa-ban"></i>
                                            </a>
                                            @elseif (request()->get('void') == 'true')
                                            <a class="btn btn-success btn-circle btn-sm btn-restore-record" data-restore-link="restore/{{ $category->id }}" data-restore-name="{{ $category->category_name }}" data-toggle="modal" data-target="#restoreModal">
