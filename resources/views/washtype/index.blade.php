                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-danger btn-circle btn-sm btn-void-record" data-void-link="{{ route('washtype.void', ['id' => $washtype->id]) }}" data-void-name="{{ $washtype->wash_type }}" data-toggle="modal" data-target="#voidModal">
                                                <i class="fas fa-ban"></i>
                                            </a>
                                            @elseif (request()->get('void') == 'true')
                                            <a class="btn btn-success btn-circle btn-sm btn-restore-record" data-restore-link="{{ route('washtype.restore', ['id' => $washtype->id]) }}" data-restore-name="{{ $washtype->wash_type }}" data-toggle="modal" data-target="#restoreModal">
