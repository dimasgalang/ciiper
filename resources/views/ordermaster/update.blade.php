        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Update Order Master</h1>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Form Update Order Master</h6>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('ordermaster.update') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div>
                                ...
                                <input class="form-control" type="text" id="order_trans" name="order_trans" value="{{ $ordermasters->order_trans }}" required readonly>
                            </div>
                            <br>
                            <div>
                                <label>Season :</label>
                            ...
                            <div>
                                ...
                                <select class="form-control" id="buyer_no" name="buyer_no">
                                    ...
                                    <option value="{{ $buyer->buyer_no }}" {{ $ordermasters->buyer_no == $buyer->buyer_no  ? 'selected' : ''}}>{{ $buyer->buyer_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <br>
                            <div>
                                ...
                                <select class="form-control" id="brand_no" name="brand_no">
                                    ...
                                    <option value="{{ $brand->brand_no }}" {{ $ordermasters->brand_no == $brand->brand_no  ? 'selected' : ''}}>{{ $brand->brand_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <br>
                            <div>
                                ...
                                <select class="form-control" id="style_no" name="style_no">
                                    ...
                                    <option value="{{ $style->style_no }}" {{ $ordermasters->style_no == $style->style_no  ? 'selected' : ''}}>{{ $style->style_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <br>
