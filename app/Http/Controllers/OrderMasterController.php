...
class OrderMasterController extends Controller
{
    public function index() {
        ...
        $ordermasters = OrderMaster::select('order_master.*','season.season_cat','buyer.buyer_name', 'brand.brand_name', 'style_name', DB::raw('round(sum(raf_production.raf_qty),2) as sum_raf_qty'))
    ...
    public function showraf($order_trans) {
        ...
        ->get();
        // return response()->json($orderlists);
        return DataTables::of($rafproductions)->make(true);
    }
