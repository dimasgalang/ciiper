        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Create Follow Up</h1>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Form Create Follow Up</h6>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('followup.store') }}" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <input class="form-control" type="text" id="fu_name" name="fu_name" required>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-12">
