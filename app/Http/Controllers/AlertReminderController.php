    ...
    public function index() {
        ...
        for ($i = 0; $i < count($fabdate); $i++) {
            if ($fabdate) {
                ...
                $datareminders[0][$countAlert] = $messageFab;
                $countAlert++;
            }
        }
        for ($i = 0; $i < count($accdate); $i++) {
            if ($accdate) {
                ...
                $datareminders[0][$countAlert] = $messageAcc;
                $countAlert++;
            }
        }
        for ($i = 0; $i < count($patterndate); $i++) {
            if ($patterndate) {
                ...
                $datareminders[0][$countAlert] = $messagePattern;
                $countAlert++;
            }
        }
        for ($i = 0; $i < count($markerdate); $i++) {
            if ($markerdate) {
                ...
                $datareminders[0][$countAlert] = $messageMarker;
                $countAlert++;
            }
        }
        for ($i = 0; $i < count($pilotrundate); $i++) {
            if ($pilotrundate) {
                ...
                $datareminders[0][$countAlert] = $messagePilotRun;
                $countAlert++;
            }
        }
        for ($i = 0; $i < count($ppmdate); $i++) {
            if ($ppmdate) {
                ...
                $datareminders[0][$countAlert] = $messagePPM;
                $countAlert++;
            }
        }
        for ($i = 0; $i < count($startcutdate); $i++) {
            if ($startcutdate) {
                ...
                $datareminders[0][$countAlert] = $messageStartCut;
                $countAlert++;
            }
        }
        for ($i = 0; $i < count($finishcutdate); $i++) {
            if ($finishcutdate) {
                ...
                $datareminders[0][$countAlert] = $messageFinnishCut;
                $countAlert++;
            }
        }
        for ($i = 0; $i < count($startsewdate); $i++) {
            if ($startsewdate) {
                ...
                $datareminders[0][$countAlert] = $messageStartSew;
                $countAlert++;
            }
        }
        for ($i = 0; $i < count($finishsewdate); $i++) {
            if ($finishsewdate) {
                ...
                $datareminders[0][$countAlert] = $messageFinishSew;
                $countAlert++;
            }
        }
        ...
        // dd($datareminders);
        return view('alert.index', compact('datareminders'));
    }
}
