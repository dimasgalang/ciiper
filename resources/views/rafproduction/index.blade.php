                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-danger btn-circle btn-sm btn-void-record" data-void-link="void/{{ $rafproduction->id }}" data-void-name="{{ $rafproduction->raf_no }}" data-toggle="modal" data-target="#voidModal">
                                                <i class="fas fa-ban"></i>
                                            </a>
                                            @elseif (request()->get('void') == 'true')
                                            <a class="btn btn-success btn-circle btn-sm btn-restore-record" data-restore-link="restore/{{ $rafproduction->id }}" data-restore-name="{{ $rafproduction->raf_no }}" data-toggle="modal" data-target="#restoreModal">
