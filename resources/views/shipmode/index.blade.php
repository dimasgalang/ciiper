                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-danger btn-circle btn-sm btn-void-record" data-void-link="void/{{ $shipmode->id }}" data-void-name="{{ $shipmode->shipmode_name }}" data-toggle="modal" data-target="#voidModal">
                                                <i class="fas fa-ban"></i>
                                            </a>
                                            @elseif (request()->get('void') == 'true')
                                            <a class="btn btn-success btn-circle btn-sm btn-restore-record" data-restore-link="restore/{{ $shipmode->id }}" data-restore-name="{{ $shipmode->shipmode_name }}" data-toggle="modal" data-target="#restoreModal">
