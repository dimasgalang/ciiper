        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Create Fabrication</h1>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Form Create Fabrication</h6>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('fabrication.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div>
                                ...
                                <select class="form-control" id="fabmill_no" name="fabmill_no">
                                    ...
                                    <option value="{{ $fabmill->fabmill_no }}">{{ $fabmill->fabmill_no }} - {{ $fabmill->fabmill_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <br>
                            <div>
                                ...
                                <textarea class="form-control" type="text" id="fabrication" name="fabrication" required></textarea>
                            </div>
                            <br>
                            <div>
                                <label>PO Fabrication :</label>
                                <textarea class="form-control" type="text" id="po_fab" name="po_fab" required></textarea>
                            </div>
                            <br>
                            <div>
                                <label>ETD :</label>
                                <textarea class="form-control" type="text" id="etd" name="etd" required></textarea>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-12">
