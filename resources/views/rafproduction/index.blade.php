                            ...
                            <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ date('dmy', strtotime($rafproduction->raf_date)) }}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-danger btn-circle btn-sm btn-void-record" data-void-link="{{ route('rafproduction.void', ['id' => $rafproduction->id]) }}" data-void-name="{{ $rafproduction->raf_no }}" data-toggle="modal" data-target="#voidModal">
                                                <i class="fas fa-ban"></i>
                                            </a>
                                            @elseif (request()->get('void') == 'true')
                                            <a class="btn btn-success btn-circle btn-sm btn-restore-record" data-restore-link="{{ route('rafproduction.restore', ['id' => $rafproduction->id]) }}" data-restore-name="{{ $rafproduction->raf_no }}" data-toggle="modal" data-target="#restoreModal">
