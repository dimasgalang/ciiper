        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Create Wash Type</h1>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Form Create Wash Type</h6>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('washtype.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div>
                                ...
                                <input class="form-control" type="text" id="wash_type" name="wash_type" required>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-12">
