        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Create Production Planning Detail</h1>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Form Create Production Planning Detail</h6>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('proplandetail.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            @endif
                            <div>
                                <label>Production Planning Detail No :</label>
                                @if($setupincements->last_number ?? '')
                                <input class="form-control" type="text" id="proplan_no" name="proplan_no" value="{{ 'PPD' . str_pad(intval(substr($setupincements->last_number,3,9)) + 1,9,'0',STR_PAD_LEFT) }}" required readonly>
                                @else
                                <input class="form-control" type="text" id="proplan_no" name="proplan_no" value="{{ 'PPD' . str_pad(1,9,'0',STR_PAD_LEFT) }}" required readonly>
                                @endif
                            </div>
                            <br>
                            <div>
                            ...
                            <div>
                                ...
                                <input class="form-control" type="number" id="percentage" name="percentage" min="0" max="100">
                            </div>
                            <br>
                            <div>
                                <label>Remark :</label>
