                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-danger btn-circle btn-sm btn-void-record" data-void-link="{{ route('proplanacc.void', ['id' => $proplanacc->id]) }}" data-void-name="{{ $proplanacc->accesories_name }}" data-toggle="modal" data-target="#voidModal">
                                                <i class="fas fa-ban"></i>
                                            </a>
                                            @elseif (request()->get('void') == 'true')
                                            <a class="btn btn-success btn-circle btn-sm btn-restore-record" data-restore-link="{{ route('proplanacc.restpre', ['id' => $proplanacc->id]) }}" data-restore-name="{{ $proplanacc->accesories_name }}" data-toggle="modal" data-target="#restoreModal">
